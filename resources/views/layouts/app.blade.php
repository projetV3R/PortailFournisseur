    ...
    <div class="flex flex-row">
      <div class="flex flex-col justify-self-start items-center w-2/5 mt-8 m-5">
        <div class="flex justify-left">
          ...
          <ul class="text-base font-raleway text-gray-500">
            <li>
              <div class="font-raleway-bold">
      ...
      <div class="w-1/5 p-10 text-gray-500 text-base bg-red-500 hidden">
        <div class="flex flex-row justify-left">
          <span class="iconify size-5" data-icon="weui:arrow-filled" data-inline="false"></span>
      ...
      <div class="flex flex-col justify-end w-2/5 mb-20 mt-8 mr-6 text-gray-400">
