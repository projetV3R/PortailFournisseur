    ...
    <div class="flex flex-row w-full max-w-screen-xl">
      <div class="flex flex-col justify-self-start items-center w-1/2 m-5">
        <div class="flex justify-self-around">
          ...
          <ul>
            <li>
              <div class="text-larger font-raleway-bold text-gray-500">
                <h4>Ville de Trois-Rivières</h4>
              </div>
            </li>
            <li>
              <div class="text-small font-raleway text-gray-500">
            ...
            <li>
              <div class="text-small font-raleway text-gray-600">
                <h4>
                  <b>
                    Téléphone:
            ...
            <li>
              <div class="text-small font-raleway text-gray-400">
      ...
      <div class="flex flex-col justify-self-end w-1/2 m-5">
          <ul class="text-small font-raleway">
            <li>
              <div class="flex flex-row flex justify-end text-small font-raleway text-gray-600">
            ...
            <li>
              <div class="flex justify-end text-gray-400">
                <a href="https://v3r.sharepoint.com/" class="hover:underline">Intranet</a> |
                <a href="https://organismesv3r.net/" class="hover:underline">Portail d'accès aux organismes</a> |
                <a href="https://www.v3r.net/politique-de-confidentialite" class="hover:underline">Politique de confidentialité</a>
              </div>
            </li>
            <li>
