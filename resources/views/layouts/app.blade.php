...
<body>
  ...
  <footer class="bg-gray-200 flex w-full">
    <div class="w-full lg:p-8 lg:flex-row flex-col  flex  gap-8 p-4 ">
      ...
      <div class="flex flex-col justify-start lg:max-w-80 gap-2 lg:gap-0 pr-10 pb-2 pl-2">
        ...
        <div class="flex text-md lg:text-sm justify-center lg:justify-start  bg-white lg:bg-gray-200 p-2 lg:p-0 hover:bg-gray-100  lg:hover:bg-gray-100">
          <h4>
            <b>Téléphone:
