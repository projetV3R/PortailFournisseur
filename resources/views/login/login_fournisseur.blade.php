        ...
        <div class="col-span-1 md:col-span-12">
            <div class="flex flex-wrap justify-center gap-4 mt-8 md:mt-16">
                <a href="{{ route('showLoginFormAvecNeq') }}">
                    <div
                        class="w-32 h-32 md:w-44 md:h-44 lg:w-56 lg:h-56 px-4 bg-primary-300 dark:bg-primary-dark-300 flex items-center justify-center cursor-pointer transform hover:scale-105 transition-transform duration-300 ease-in-out">
                ...
                <a href="{{ route('showLoginFormSansNeq') }}">
                    <div
                        class="w-32 h-32 md:w-44 md:h-44 lg:w-56 lg:h-56 px-4 bg-secondary-300 dark:bg-secondary-dark-300 flex items-center justify-center cursor-pointer transform hover:scale-105 transition-transform duration-300 ease-in-out">
                ...
                <a href="{{ route('CreateIdentification') }}">
                    <div
                        class="w-32 h-32 md:w-44 md:h-44 lg:w-56 lg:h-56 px-4 bg-tertiary-300 dark:bg-tertiary-dark-300 flex items-center justify-center cursor-pointer transform hover:scale-105 transition-transform duration-300 ease-in-out">
