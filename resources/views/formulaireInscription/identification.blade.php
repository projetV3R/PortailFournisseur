            ...
            <div>
                <div class="bg-secondary-100 dark:bg-secondary-dark-100 py-8 px-4 mt-8">
                    ...
                    <button type="submit" id="fetchLicenceBtn"
                        class="mt-9 w-full text-white bg-tertiary-400 hover:bg-tertiary-300 dark:bg-tertiary-dark-400 dark:hover:bg-tertiary-dark-300 py-2.5 daltonien:hover:bg-daltonienYellow daltonien:hover:text-black">
