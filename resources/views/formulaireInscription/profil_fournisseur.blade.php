...
@section('contenu')
    ...
    <div class="p-4 md:p-16">
        <div class="flex w-full">
            ...
            <div class="bg-green-100 ml-2 w-1/2 py-4 px-6 mb-4 mt-8 flex items-center">
            ...
            <div>
                ...
                <div class="bg-primary-100 py-8 px-4 mt-8 relative">
                    ...
                    <div id="contactsContainer"
                        ...
                        <div class="bg-white p-4">
                            <div class="flex justify-between">
                                <div class="w-1/2 pr-2">
                                    ...
                                    <p class="mt-2 font-Alumni md:text-lg"><strong>Email:</strong> jean.dupont@example.com
                                    </p>
                                </div>
                                ...
                                <div class="w-1/2 pl-2">
                                    ...
                                    <p class="mt-2 font-Alumni md:text-lg"><strong>Numéro Tél:</strong> 06 12 34 56
                                        78</p>
                        ...
                        <div class="bg-white p-4">
                            <div class="flex justify-between">
                                <div class="w-1/2 pr-2">
                                    ...
                                    <p class="mt-2 font-Alumni md:text-lg"><strong>Email:</strong> marie.martin@example.com
                                    </p>
                                </div>
                                ...
                                <div class="w-1/2 pl-2">
                                    ...
                                    <p class="mt-2 font-Alumni md:text-lg"><strong>Numéro Tél:</strong> 06 23 45 67
                                        89</p>
                        ...
                        <!-- Ajoutez d'autres contacts de la même manière -->
                    </div>
                </div>
