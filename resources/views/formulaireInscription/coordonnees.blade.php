            ...
            <div class="bg-primary-100 py-8 px-4 mt-8 ">
                ...
                <div class="mt-6 w-full max-w-md flex gap-4 columns-2 ">
                    ...
                    <div class="w-1/4">
                        ...
                        <input type="text" id="numeroCivique" name="numeroCivique" placeholder="Numero Civique"
                    ...
                    <div class="w-1/4">
                        ...
                        <input type="text" id="bureau" name="bureau" placeholder="Bureau"
                            class="font-Alumni w-full p-2 h-12 h-12focus:outline-none focus:border-blue-500 border border-black">
                    </div>
                </div>
...
"extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"shrink-0 size-3.5 text-gray-500 \" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
        ...
        <div>
            ...
            <button type="button" class="mt-16 w-full text-white bg-secondary-400 hover:bg-tertiary-300 py-2.5">
                <h1 class="font-Alumni font-bold text-lg md:text-2xl">Ajouter</h1>
            </button>

            <button type="button" class="mt-4 w-full text-white bg-tertiary-400 hover:bg-tertiary-300 py-2.5">
